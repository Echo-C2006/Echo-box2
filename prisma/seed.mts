...
const USERS: UserSeed[] = [
  ...
  // ---- 以下为人才库演示用户（不与任何帖子/队伍关联） ----
  {
    nickname: "黄思远", grade: "大二", major: "物理学",
    bio: "物理专业，擅长数学推导和物理建模，自学Python和MATLAB，希望找到数模队伍。",
    skills: ["Python", "MATLAB", "数学推导", "物理建模", "LaTeX"],
    interests: ["数学建模", "物理竞赛"],
    experience: "全国大学生物理学术竞赛华东赛区二等奖",
    timeCommitment: "每周可投入15小时",
    profileTipSeen: true,
    createdAt: daysAgo(3),
  },
  {
    nickname: "唐晓雅", grade: "大三", major: "经济学",
    bio: "经济学专业，擅长数据分析与计量建模，会用Python做数据处理和可视化。",
    skills: ["Python", "R", "stata", "数据分析", "计量建模"],
    interests: ["数学建模", "创新创业"],
    experience: "全国大学生市场调查与分析大赛省一等奖",
    timeCommitment: "每周可投入15小时",
    profileTipSeen: true,
    createdAt: daysAgo(3),
  },
  {
    nickname: "何嘉文", grade: "研一", major: "生物医学工程",
    bio: "研究方向为医学图像处理，熟悉深度学习模型，有EI论文一篇。",
    skills: ["PyTorch", "Python", "TensorFlow", "医学图像", "信号处理"],
    interests: ["程序设计", "电子工程"],
    experience: "全国大学生生物医学工程创新设计竞赛国家二等奖",
    timeCommitment: "每周可投入20小时",
    profileTipSeen: true,
    createdAt: daysAgo(2),
  },
  {
    nickname: "许若曦", grade: "大二", major: "新闻传播学",
    bio: "校园媒体主编，擅长文案策划、视频剪辑和PPT设计，执行力强。",
    skills: ["文案策划", "视频剪辑", "PPT设计", "Premiere", "新媒体运营"],
    interests: ["创新创业", "艺术设计"],
    experience: "全国大学生广告艺术大赛省二等奖、校媒年度最佳主编",
    timeCommitment: "每周可投入12小时",
    profileTipSeen: true,
    createdAt: daysAgo(2),
  },
  {
    nickname: "高铭泽", grade: "大三", major: "化学工程与工艺",
    bio: "化工专业，对化工设计竞赛有兴趣，熟练使用Aspen和Origin。",
    skills: ["Aspen", "Origin", "MATLAB", "数据分析", "实验设计"],
    interests: ["化学工程", "数学建模"],
    experience: "全国大学生化工设计竞赛华南赛区一等奖",
    timeCommitment: "每周可投入18小时",
    profileTipSeen: true,
    createdAt: daysAgo(2),
  },
  {
    nickname: "沈心怡", grade: "大四", major: "金融学",
    bio: "已获券商offer，擅长金融建模与量化分析，CFA一级通过。",
    skills: ["Python", "量化分析", "金融建模", "R", "Excel"],
    interests: ["数学建模", "创新创业"],
    experience: "CFA投资分析大赛华南赛区亚军",
    timeCommitment: "每周可投入10小时",
    profileTipSeen: true,
    createdAt: daysAgo(1),
  },
  {
    nickname: "陆一鸣", grade: "大一", major: "计算机科学与技术",
    bio: "大一新生但已自学完数据结构与算法，Codeforces 1400+，充满干劲！",
    skills: ["C++", "Python", "算法", "数据结构", "Linux"],
    interests: ["程序设计", "数学建模"],
    experience: "新生程序设计大赛校一等奖、蓝桥杯省赛（即将参赛）",
    timeCommitment: "每周可投入25小时",
    profileTipSeen: true,
    createdAt: daysAgo(1),
  },
  {
    nickname: "顾诗雅", grade: "大三", major: "建筑学",
    bio: "建筑学专业，擅长参数化设计和渲染出图，熟练使用Grasshopper。",
    skills: ["Rhino", "Grasshopper", "CAD", "Photoshop", "参数化设计"],
    interests: ["艺术设计", "土木工程"],
    experience: "全国高等学校建筑设计竞赛三等奖",
    timeCommitment: "每周可投入15小时",
    profileTipSeen: true,
    createdAt: daysAgo(1),
  },
  {
    nickname: "段鹏飞", grade: "研二", major: "控制科学与工程",
    bio: "研究方向为无人机自主导航，有SCI论文一篇，ROS/PX4开发经验丰富。",
    skills: ["ROS", "PX4", "C++", "Python", "SLAM"],
    interests: ["机器人", "电子工程"],
    experience: "全国无人飞行器设计大赛国家一等奖、SCI三区论文一篇",
    timeCommitment: "每周可投入20小时",
    profileTipSeen: true,
    createdAt: daysAgo(1),
  },
  {
    nickname: "温馨", grade: "大二", major: "工商管理",
    bio: "学生会外联部长，擅长商业计划书撰写和路演答辩，有创业项目落地经验。",
    skills: ["商业计划", "路演答辩", "项目管理", "PPT设计", "市场调研"],
    interests: ["创新创业"],
    experience: "互联网+校赛金奖、创青春省赛银奖（项目：校园二手书平台）",
    timeCommitment: "每周可投入15小时",
    profileTipSeen: true,
    createdAt: daysAgo(0),
  },
